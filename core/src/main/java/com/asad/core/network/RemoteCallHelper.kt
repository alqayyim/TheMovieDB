...
import com.asad.core.data.BaseResponse
import com.asad.core.data.ErrorCodesMapper
import com.asad.core.data.NetworkCodes
import com.google.gson.Gson
import com.google.gson.reflect.TypeToken
import com.asad.core.data.ResultWrapper
    ...
    return withContext(dispatcher) {
        try {
            ...
            if (call.isSuccessful) ResultWrapper.Success(call)
                ...
                val errorResponse: BaseResponse? = convertErrorBody(call.errorBody())
...
private fun convertErrorBody(response: ResponseBody?): BaseResponse? {
    return try {
